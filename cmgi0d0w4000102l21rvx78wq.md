...
2. What is typecasting? Example.
    
3. Difference between implicit and explicit typecasting.
...
7. Purpose of `this` keyword.
    
8. Purpose of `super` keyword.
    
9. Difference between `public`, `private`, `protected`, default access modifiers.
    
10. Difference between `==` and `equalsIgnoreCase()` for Strings.
    
11. Difference between `char` and `Character` class.
    
12. What is wrapper class? Why is it used?
    
13. Autoboxing and unboxing in Java.
    
14. What is `var` keyword in Java 10?
    
15. Difference between `null` and empty string.
    
16. Difference between `System.out.print` and `System.out.println`.
    
17. What is the default value of instance/static variables?
